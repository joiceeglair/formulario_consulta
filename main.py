...
frame_direita=Frame(janela, width=588, height=103, bg=co1, relief='flat')
frame_direita.grid(row=0, column=1, rowspan=2, sticky=NSEW, padx=1, pady=0)

app_nome = Label(frame_cima, text='Formulario de Consultoria', anchor=NW, font=('Ivy 13 bold'), bg=co2, fg=co1, relief='flat')
...
l_cal = Label(frame_baixo, text='Data de consulta', anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4, relief='flat')
...
l_extra = Label(frame_baixo, text='Informação extra', anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4, relief='flat')
l_extra.place(x=15, y=260)
e_extra = Entry(frame_baixo, width=45, justify='left', relief='solid')
e_extra.place(x=15, y=290)

b_inserir = Button(frame_baixo,command=inserir, text='Inserir', width=10, anchor=NW, font=('Ivy 7 bold'), bg=co6, fg=co1, relief='raised', overrelief='ridge')
b_inserir.place(x=15, y=340)

b_atualizar = Button(frame_baixo, command=atualizar, text='Atualizar', width=10, anchor=NW, font=('Ivy 7 bold'), bg=co2, fg=co1, relief='raised', overrelief='ridge')
b_atualizar.place(x=110, y=340)

b_deletar = Button(frame_baixo, command=deletar, text='Excluir', width=10, anchor=NW, font=('Ivy 7 bold'), bg=co7, fg=co1, relief='raised', overrelief='ridge')
